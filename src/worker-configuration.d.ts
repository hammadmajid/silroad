/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: c0731e2ddde77becdcd416eaac7ab387)
// Runtime types generated with workerd@1.20250730.0 2025-08-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		PUBLIC_TURNSTILE_KEY: "0x4AAAAAABpHqAl_uR3jNJ2x";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_TOKEN" | "NODE_ENV" | "SECRET_TURNSTILE_KEY">> {}
}
