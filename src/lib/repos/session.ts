...
export class SessionRepo {
  ...
  async getByUserId(userId: string): Promise<SerializableSession[]> { throw "not implemented" }
  async update(session: SerializableSession): Promise<SerializableSession> { throw "not implemented" }
  async delete(sessionToken: string): Promise<void> { throw "not implemented" }
  async deleteByUserId(userId: string): Promise<number> { throw "not implemented" }
  async invalidate(sessionToken: string): Promise<void> { throw "not implemented" }
  async refresh(sessionToken: string): Promise<SerializableSession> { throw "not implemented" }
  async getExpired(before: Date): Promise<SerializableSession[]> { throw "not implemented" }
  async deleteExpired(): Promise<number> { throw "not implemented" }
}
